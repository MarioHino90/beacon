 ...
 */
export declare function mergeAllTranslations(translationFilePath: string, localesPaths: string[], typescriptDefinitionPath: string, indexDTsInterfaceName: string, pattern?: string): Promise<void>;
