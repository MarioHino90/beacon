// forked because audit fails on moment being old-as-dirt
/**
 * webpack-convict
...
var types = {
    ...
    port: function (x) {
        assert(Number.isInteger(x) && x >= 0 && x <= 65535, 'Ports must be within range 0 - 65535');
    },
    url: function (x) {
...
function importEnvironment(o) {
    // don't do anything - process.env has no relevance in a webpack env
}
function importArguments(o) {
    // don't do anything - process.argv has no relevance in a webpack env
}
