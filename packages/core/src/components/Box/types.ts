...
export interface StyledBoxProps<T extends Record<string, unknown> = {}>
  extends BaseStyledBoxProps {
  /**
  ...
  styledCss?:
    ...
    | FlattenInterpolation<ThemedStyledProps<BaseStyledBoxProps, T>>;
}
