...
interface BaseStyledFlexBoxProps
...
export interface StyledFlexBoxProps<T extends Record<string, unknown> = {}>
  extends BaseStyledFlexBoxProps {
  /** prop to interpolate the returned value of a `css` call within styled-components */
  styledCss?:
    | FlattenSimpleInterpolation
    // eslint-disable-next-line @typescript-eslint/ban-types
    | FlattenInterpolation<ThemedStyledProps<{}, T>>
    | FlattenInterpolation<ThemedStyledProps<BaseStyledFlexBoxProps, T>>;
}
