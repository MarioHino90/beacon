...
export type ToastOptions = Pick<
  TO,
  "onClick" | "onOpen" | "onClose" | "toastId" | "containerId" | "autoClose"
>;

export interface StyledToasterProps extends ToastContainerProps {}

export interface ToasterProps
  extends Pick<StyledToasterProps, "autoClose" | "className" | "limit"> {
...
export interface StyledToastCloseButtonProps
