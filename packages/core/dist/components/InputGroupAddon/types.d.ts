...
export interface StyledInputGroupAddonProps<T extends Record<string, unknown> = {}> extends InputGroupContextInterface, React.HTMLAttributes<HTMLElement> {
    ...
    styledCss?: FlattenSimpleInterpolation | FlattenInterpolation<ThemedStyledProps<{}, T>> | FlattenInterpolation<ThemedStyledProps<InputGroupContextInterface, T>>;
}
