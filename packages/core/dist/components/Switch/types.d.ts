...
export interface StyledSwitchWrapperProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
}
...
export interface HiddenCheckboxProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
}
