...
export interface StyledFieldLabelInfoIconButtonProps extends React.HTMLAttributes<HTMLButtonElement> {
    /** controls the color of the icon */
    variant: "muted" | "primary";
}
export interface StyledFieldLabelProps extends React.HTMLAttributes<HTMLLabelElement> {
}
