...
export declare const SkeletonLoader: import("styled-components").StyledComponent<"div", any, {
    variant: import("./types").SkeletonLoaderVariant | undefined;
    className: string;
