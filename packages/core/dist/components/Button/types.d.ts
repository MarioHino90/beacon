...
export interface StyledLoadingIconWithGradientProps extends Pick<BaseButtonProps, "size"> {
}
export interface LoadingIconWithGradientProps extends StyledLoadingIconWithGradientProps, BaseButtonProps {
}
export interface StyledLoadedWithIconProps extends React.HTMLAttributes<HTMLSpanElement> {
    /** indicates that the icon should be animated */
    isAnimated?: boolean;
}
export interface LoadedWithIconProps extends Pick<IconProps, "name">, StyledLoadedWithIconProps {
}
...
export interface ButtonProps extends Partial<StyledButtonProps>, Partial<ButtonContentProps> {
    ...
    getAriaLabel?: (loadingState: ButtonLoadingState | undefined) => string | undefined;
}
export interface StyledButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement>, BaseButtonProps {
