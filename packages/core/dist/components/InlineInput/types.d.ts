...
export declare type PrevValue = string | readonly string[] | number | undefined;
export declare type TransitionState = "waiting" | "canceling" | "clearing";
export declare type Actions = SetEditModeAction | SetPrevValueAction | SetIsCancelingAction | SaveAction | CancelAction | CancelCompleteAction | ClearAction | ClearCompleteAction;
export interface InlineInputProps extends Omit<InlineInputEditModeProps, "children" | "inputRef">, Pick<InlineInputViewModeProps, "children"> {
...
export declare type OnChangeAction = "change" | "save" | "cancel" | "clear";
export interface InlineInputEditModeProps extends Pick<StyledInlineInputEditModeProps, "vSize">, Omit<InputProps, "onChange"> {
    ...
    onChange?: (event: React.ChangeEvent<HTMLInputElement>, action: OnChangeAction) => void;
...
export interface StyledInlineInputEditModeProps extends React.HTMLAttributes<HTMLElement> {
...
export interface InlineInputViewModeProps extends Omit<StyledInlineInputViewModeProps, "children"> {
...
export interface StyledInlineInputViewModeProps extends React.HTMLAttributes<HTMLElement> {
