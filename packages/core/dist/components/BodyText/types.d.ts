...
export declare type BodyTextSizes = "sm" | "md" | "label";
export declare type BodyTextVariants = "success" | "danger" | "warning" | "info" | "hint";
export declare type BodyTextDecorations = "underline" | "line-through";
