...
export declare const StyledBannerButton: import("styled-components").StyledComponent<import("react").ForwardRefExoticComponent<import("../Button").ButtonProps & import("react").RefAttributes<HTMLButtonElement>>, any, {
    getAriaLabel?: ((loadingState: import("@braze/beacon-hooks").ButtonLoadingState | undefined) => string | undefined) | undefined;
