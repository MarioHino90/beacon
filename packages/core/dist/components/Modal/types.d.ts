...
export declare type IconType = "warning";
export interface StyledModalBackdropProps extends React.HTMLAttributes<HTMLDivElement> {
    /** z-index value for the component */
    zIndex?: number;
}
export interface ModalBackdropProps extends StyledModalBackdropProps {
}
export interface StyledModalContentProps extends React.HTMLAttributes<HTMLDivElement>, Required<ModalContextInterface> {
}
...
export interface StyledModalDialogProps extends React.HTMLAttributes<HTMLElement> {
    /** indicates whether component should be visible */
    isOpen?: boolean;
    /** z-index value for the component */
    zIndex: number;
...
export interface ModalProps extends StyledModalProps, Omit<ModalContentProps, "ref" | "size">, Partial<Pick<ModalContentProps, "size">> {
