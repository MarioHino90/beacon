...
export declare type SortDirectionOrder = ["asc", "desc"] | ["desc", "asc"];
...
export interface StyledTableHeaderCellProps extends TableCellProps, React.TableHTMLAttributes<HTMLTableHeaderCellElement> {
}
export interface TableHeaderCellProps extends StyledTableHeaderCellProps {
    ...
    /** callback called when the column is clicked to change sorting */
    onSortColumn?: (sortDirection: SortDirection) => void;
