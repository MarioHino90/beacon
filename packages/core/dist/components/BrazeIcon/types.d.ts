...
export declare type GenericSpotIcon<Props> = React.LazyExoticComponent<{
...
export interface StyledBrazeIconProps extends React.HTMLAttributes<HTMLElement> {
    /**
     * child elements to be rendered inside the component tree */
    children?: React.ReactNode | React.ReactNode[];
}
export interface AddDocumentProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface AddImageOrDocumentProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface ArrowToggleProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface CampaignComparisonProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface ContentProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface FunnelReportProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
export interface EmailSettingsProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
...
export interface RetentionReportProps extends React.SVGAttributes<HTMLOrSVGElement> {
}
